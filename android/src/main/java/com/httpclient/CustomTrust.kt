...
-----END CERTIFICATE-----
""".decodeCertificatePem()
  val letsEncryptCertificateAuthority = """-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----""".decodeCertificatePem()
  ...
  fun getClient(): OkHttpClient {
    ...
    val certificates: HandshakeCertificates = HandshakeCertificates.Builder()
      ...
      .addTrustedCertificate(comodoRsaCertificationAuthority) // Uncomment if standard certificates are also required.
