...
class NativeHttpClient(reactContext: ReactApplicationContext) :
  ...
  fun get(
    ...
    val client = CustomTrust.getClient()
      ...
      override fun onResponse(call: Call, response: Response) {
        response.body?.use { responseBody ->
          val requestHeadersMap =
            call.request().headers.toMultimap().mapValues { it.value.joinToString(",") }
