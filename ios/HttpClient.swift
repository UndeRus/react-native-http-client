...
class HttpClient: NSObject {
    ...
    @objc(post:optionsJson:resolver:rejecter:)
    func post(_ url: String, optionsJson: String?, resolver resolve: @escaping RCTPromiseResolveBlock, rejecter reject: @escaping RCTPromiseRejectBlock) {
        var components = URLComponents(string: url)
